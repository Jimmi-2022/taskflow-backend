...
Endpoints:
    ...
    [] Расписание
        [X] [GET] /api/schedule: Получение расписания событий и задач
        [X] [POST] /api/schedule: Создание нового события
        [X] [GET] /api/schedule/:id: Получение информации о конкретном событии
        [X] [PUT] /api/schedule/:id: Обновление информации о событии
        [] [DELETE] /api/schedule/:id: Удаление события
    [] Активность
        [X] [POST] /api/activity: Добавление ленты активности пользователей и проектов
    [] Команда
